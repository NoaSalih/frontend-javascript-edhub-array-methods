...
// Verwachte uitkomst:
// [{ first: 'Galileo', last: 'Galilei', year: 1564, passed: 1642 }, { first: 'Johannes', last: 'Kepler', year: 1571,
// passed: 1630 }]
...
const allBirthYears = inventors.map((inventor) => {
...
// Verwachte uitkomst: [ 'Albert Einstein', 'Isaac Newton', 'Galileo Galilei', 'Marie Curie', 'Johannes Kepler',
// 'Nicolaus Copernicus', 'Max Planck', 'Katherine Blodgett', 'Ada Lovelace', 'Sarah E. Goode', 'Lise Meitner', 'Thomas
// Edison']
...
//   { first: 'Katherine', last: 'Blodgett', year: 1898, passed: 1979 }
// ]
const sortedYearOfBirth = inventors.sort((a, b) => a.year - b.year);
console.log(sortedYearOfBirth);
